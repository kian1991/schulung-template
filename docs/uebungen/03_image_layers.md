...
### Aufgabe 2: Der Müllschlucker (.dockerignore)
...
1. Ziehe dir das Image `python:3.9-slim`.
2. Finde heraus, wie groß das Image ist und wie viele Layer es hat.
3. Nutze `docker history --no-trunc python:3.9-slim`, um genau zu sehen, welcher Befehl wie viel Platz verbraucht hat.
